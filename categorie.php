            ...
            <tbody>
              <?php foreach ($all_categories as $cat):?>
                <tr>
                  ...
                  <td><?php echo read_date($cat['date']); ?></td>
                    <td class="text-center">
                      <div class="btn-group">
                        <a href="filter_product.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-xs btn-primary" data-toggle="tooltip" title="Ver Productos">
